package luiz787.uniquedigit.core.user;
...
import luiz787.uniquedigit.core.CryptoUtils;
...
public class UserController {
  ...
  public ResponseEntity<User> update(
      @PathVariable @ApiParam("Id of the user to be updated") final long id,
      @RequestBody @Valid @ApiParam("Updated user data") final SaveUserDto newUserData) {
    return userRepository
        .findById(id)
  ...
  public ResponseEntity<Void> delete(
      @PathVariable @ApiParam("Id of the user to be deleted") final long id) {
